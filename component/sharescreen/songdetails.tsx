            ...
            >
                ...
                <View style={styles.actionsRow}>
                    ...
                    <View style={{ flexDirection: "row", gap: 10, alignItems: "center" }}>
                        ...
                        <TouchableOpacity onPress={() => { router.push("/drawer/musicplayingscreen"), console.log("routing to play screen") }} style={styles.playButton}>
                ...
                <View style={styles.artistSection}>
                    ...
                    <Text style={styles.artistLabel}>This is new</Text>
                </View>
